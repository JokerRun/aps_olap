...
select md5(CONCAT(item_nr, location_nr, storage_location, batch_nr, inventory_doc_nr,
       ...
       md5(CONCAT_WS(',', inventory_doc_nr, inventory_doc_line)) as h_inventory_doc_hk,
...
truncate stage_area.stage_inventory_movement;
alter table stage_area.stage_inventory_movement
    add constraint stage_inventory_movement_pk unique (load_date, load_seq);
alter table stage_area.stage_inventory_movement
    modify load_seq bigint null;
